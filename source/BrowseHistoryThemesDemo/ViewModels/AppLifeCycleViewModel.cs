namespace BrowseHistoryThemesDemo.ViewModels
{
    ...
    /// </summary>
    public class AppLifeCycleViewModel : BrowserHistoryDemoLib.ViewModels.Base.BaseViewModel
    {
        #region fields
                                          ...
                                          , IAppearanceManager appearance)
        {
            try
            {
                ...
                appearance.AddThemeResources("Dark", new List<Uri>
                {
                   ...
                   , new Uri("/BrowseHistoryThemesDemo;component/BindToMLib/HistoryControlLib/DarkLightBrushs.xaml", UriKind.RelativeOrAbsolute)
                   , new Uri("/BrowseHistoryThemesDemo;component/BindToMLib/MWindowLib/DarkBrushs.xaml", UriKind.RelativeOrAbsolute)
                }, settings.Themes);
            }
            catch
            {
            ...
            try
            {
                ...
                appearance.AddThemeResources("Light", new List<Uri>
                {
                   ...
                   , new Uri("/BrowseHistoryThemesDemo;component/BindToMLib/HistoryControlLib/DarkLightBrushs.xaml", UriKind.RelativeOrAbsolute)
                   , new Uri("/BrowseHistoryThemesDemo;component/BindToMLib/MWindowLib/LightBrushs.xaml", UriKind.RelativeOrAbsolute)
                }, settings.Themes);
            }
            catch
            {
